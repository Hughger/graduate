...
module testbench;
    ...
    localparam integer WEIGHT_ADDR_WIDTH       = 25;   // io_weightSramRead*_readAddress
    localparam integer WEIGHT_DATAW            = 256;  // io_weightSramRead*_readData
    localparam integer OUTPUT_ADDR_WIDTH       = 15;   // io_outputSram*_read/writeAddress
    localparam integer OUTBUF_DATAW            = 512;  // io_outputSram*_read/writeData
    localparam integer JOINT_ADDR_WIDTH        = 15;   // io_jointSram_read/writeAddress
...
`endif
    ...
    always @* begin
        watchdog_limit = 4 * cout * k * k * groupSize * 10;
    end
    ...
    localparam [CFG_ADDRW-1:0] GLOBAL_CONF_ID     = 32'd65;  // 0x41 global
    localparam [CFG_ADDRW-1:0] RUN_PROCESS_ID     = 32'd66;  // 0x42 run
    localparam [CFG_ADDRW-1:0] INTR_FRESH_ID      = 32'd67;  // 0x43 interruptFresh

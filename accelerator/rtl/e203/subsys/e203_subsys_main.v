...
`endif//}
 ...
 e203_subsys_plic u_e203_subsys_plic(
    ...
    .pwm_irq_0              (pwm_irq_0 ),
    .pwm_irq_1              (pwm_irq_1 ),
    .pwm_irq_2              (pwm_irq_2 ),    // 恢复PWM2中断
    .pwm_irq_3              (pwm_irq_3 ),    // 恢复PWM3中断
                                        
    .i2c0_mst_irq           (1'b0     ),
    .i2c1_mst_irq           (1'b0     ),
    .mac_done_irq           (mac_done_irq),
    .mac_err_irq            (mac_err_irq ),
    .gpioA_irq              (1'b0     ),     // GPIO A中断不再使用
    .gpioB_irq              (1'b0     ),     // GPIO B中断不再使用
    
    // DMA中断连接
    .dma_done_irq           (dma_done_irq),
    .dma_err_irq            (dma_err_irq ),

...
module e203_subsys_plic(
  ...
  input  i2c0_mst_irq,
  input  i2c1_mst_irq,
  // Replace I2C IRQs with MAC IRQs
  input  mac_done_irq,
  input  mac_err_irq,
  ...
  // Map MAC IRQs to source 12 and 13
  wire plic_irq_i_12 = mac_done_irq;
  wire plic_irq_i_13 = mac_err_irq;
  wire plic_irq_i_14 = dma_done_irq;    // DMA完成中断替换GPIO A中断
  wire plic_irq_i_15 = dma_err_irq;     // DMA错误中断替换GPIO B中断 

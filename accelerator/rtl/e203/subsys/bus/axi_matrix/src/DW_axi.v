...
module DW_axi (
  ...
  aclk
               ...
               ,rlast_m2
               ,rready_m2
               // Write Address Channel from Master3
               ,awvalid_m3
               ,awaddr_m3
               ,awid_m3
               ,awlen_m3
               ...
               ,awprot_m3
               ,awready_m3
               // Write Data Channel from Master3
               ,wvalid_m3
               ,wdata_m3
               ,wstrb_m3
               ,wlast_m3
               ,wready_m3
               // Write Response Channel from Master3
               ,bvalid_m3
               ,bid_m3
               ,bresp_m3
               ,bready_m3
               // Read Address Channel from Master3
               ,arvalid_m3
               ,arid_m3
               ,araddr_m3
               ,arlen_m3
               ...
               ,arprot_m3
               ,arready_m3
               // Read Data Channel from Master3
               ,rvalid_m3
               ,rid_m3
               ,rdata_m3
               ,rresp_m3
...
// Write Address Channel from Master3
  input                       awvalid_m3;
  input  [`AXI_AW-1:0]        awaddr_m3;

  input  [`AXI_IDW_M3-1:0]     awid_m3;

  input  [`AXI_BLW-1:0]       awlen_m3;
  input  [`AXI_BSW-1:0]       awsize_m3;
  input  [`AXI_BTW-1:0]       awburst_m3;
  input  [`AXI_LTW-1:0]       awlock_m3;
  input  [`AXI_CTW-1:0]       awcache_m3;
  input  [`AXI_PTW-1:0]       awprot_m3;
  output                      awready_m3;
...
// Write Data Channel from Master3
  ...
  input  [`AXI_DW-1:0]        wdata_m3;
  input  [`AXI_SW-1:0]        wstrb_m3;
  input                       wlast_m3;
  output                      wready_m3;
// Write Response Channel from Master3
  output                      bvalid_m3;

  output [`AXI_IDW_M3-1:0]     bid_m3;

  output [`AXI_BRW-1:0]       bresp_m3;
  input                       bready_m3;
// Read Address Channel from Master3
  input                       arvalid_m3;

  input  [`AXI_IDW_M3-1:0]     arid_m3;

  input  [`AXI_AW-1:0]        araddr_m3;
  input  [`AXI_BLW-1:0]       arlen_m3;
  input  [`AXI_BSW-1:0]       arsize_m3;
  input  [`AXI_BTW-1:0]       arburst_m3;
  input  [`AXI_LTW-1:0]       arlock_m3;
  input  [`AXI_CTW-1:0]       arcache_m3;
  input  [`AXI_PTW-1:0]       arprot_m3;
  output                      arready_m3;
...
// Read Data Channel from Master3
  ...
  output [`AXI_IDW_M3-1:0]     rid_m3;

  output [`AXI_DW-1:0]        rdata_m3;
  output                      rlast_m3;
  output [`AXI_RRW-1:0]       rresp_m3;
  input                       rready_m3;
...
// Read Data Channel from Slave2
 ...
 wire                                       has_aw_pending_trans_m2;
  wire                                      arvalid_m3;
  wire [`AXI_AR_PYLD_M_W-1:0]               arpayload_m3;
  wire                                      arready_m3;
  wire [`AXI_NSP1V_M3-1:0]                           bus_arready_m3;
  wire [`AXI_NSP1V_M3-1:0]                    mp_arvalid_m3;
  wire [`AXI_NSP1V_M3-1:0]                    mp_arvalid_m3_q;
  wire                                              ar_shrd_ch_req_m3;
  wire [`AXI_AR_PYLD_S_W-1:0]                   mp_arpayload_m3;
 
 
  wire                                      rready_m3;
  wire                                      rvalid_m3;
  wire [`AXI_R_PYLD_M_W-1:0]               rpayload_m3;
  wire [`AXI_R_M3_NSV-1:0]                    bus_rvalid_m3;
  wire [(`AXI_R_M3_NSV*`AXI_R_PYLD_M_W)-1:0]    bus_rpayload_m3;
  wire [`AXI_R_M3_NSV-1:0]            bus_mp_rready_m3;
 
  wire                                      awvalid_m3;
  wire [`AXI_AW_PYLD_M_W-1:0]               awpayload_m3;
  wire                                      awready_m3;
  wire [`AXI_NSP1V_M3-1:0]                    bus_awready_m3;
  wire [`AXI_NSP1V_M3-1:0]                    aw_shrd_lyr_granted_m3_s_bus;
  wire [`AXI_NSP1V_M3-1:0]                    issued_wtx_shrd_sys_m3_s_bus;
  wire [`AXI_NSP1V_M3-1:0]                    mp_awvalid_m3;
  wire [`AXI_NSP1V_M3-1:0]                    mp_awvalid_m3_q;
  wire                                              aw_shrd_ch_req_m3;
  wire [(`AXI_AW_PYLD_S_W)-1:0]             mp_awpayload_m3;
 
  wire                                      wvalid_m3;
  wire [`AXI_W_PYLD_M_W-1:0]               wpayload_m3;
  wire                                      wready_m3;
  wire [`AXI_NSP1V_M3-1:0]                    bus_wready_m3;
  wire [`AXI_NSP1V_M3-1:0]                    mp_wvalid_m3;
  wire                                              w_shrd_ch_req_m3;
  wire [(`AXI_W_PYLD_S_W)-1:0]              mp_wpayload_m3;
 
  wire                                      bready_m3;
  wire                                      bvalid_m3;
  wire [`AXI_B_PYLD_M_W-1:0]               bpayload_m3;
  wire [`AXI_B_M3_NSV-1:0]                    bus_bvalid_m3;
  wire [(`AXI_B_M3_NSV*`AXI_B_PYLD_M_W)-1:0]    bus_bpayload_m3;
  wire [`AXI_B_M3_NSV-1:0]            bus_mp_bready_m3;
 ...
 wire                                        has_aw_pending_trans_m16;
  ...
  wire [`AXI_NSP1V_M3-1:0] bus_tz_secure_m3;
...
// master port (i.e. shared to dedicated link).
    ...
    wire                                      bvalid_s1_m2;
    wire                                      bready_s1_m2;
    wire [`AXI_R_PYLD_M_W-1:0]               rpayload_s2_m2;
    wire [`AXI_B_PYLD_M_W-1:0]               bpayload_s2_m2;
    wire                                      arready_s2_m2;
    wire                                      arvalid_s2_m2;
    wire [`AXI_AR_PYLD_S_W-1:0]               arpayload_s2_m2;
    wire                                      rvalid_s2_m2;
    wire                                      rready_s2_m2;
    wire                                      awready_s2_m2;
    wire                                      awvalid_s2_m2;
    wire [`AXI_AW_PYLD_S_W-1:0]               awpayload_s2_m2;
    wire                                      wready_s2_m2;
    wire                                      wvalid_s2_m2;
    wire [`AXI_W_PYLD_S_W-1:0]               wpayload_s2_m2;
    wire                                      bvalid_s2_m2;
    wire                                      bready_s2_m2;
    wire [`AXI_R_PYLD_M_W-1:0]               rpayload_s0_m3;
    wire [`AXI_B_PYLD_M_W-1:0]               bpayload_s0_m3;
    wire                                      arready_s0_m3;
    wire                                      arvalid_s0_m3;
    wire [`AXI_AR_PYLD_S_W-1:0]               arpayload_s0_m3;
    wire                                      rvalid_s0_m3;
    wire                                      rready_s0_m3;
    wire                                      awready_s0_m3;
    wire                                      awvalid_s0_m3;
    wire [`AXI_AW_PYLD_S_W-1:0]               awpayload_s0_m3;
    wire                                      wready_s0_m3;
    wire                                      wvalid_s0_m3;
    wire [`AXI_W_PYLD_S_W-1:0]               wpayload_s0_m3;
    wire                                      bvalid_s0_m3;
    wire                                      bready_s0_m3;
    wire [`AXI_R_PYLD_M_W-1:0]               rpayload_s1_m3;
    wire [`AXI_B_PYLD_M_W-1:0]               bpayload_s1_m3;
    wire                                      arready_s1_m3;
    wire                                      arvalid_s1_m3;
    wire [`AXI_AR_PYLD_S_W-1:0]               arpayload_s1_m3;
    wire                                      rvalid_s1_m3;
    wire                                      rready_s1_m3;
    wire                                      awready_s1_m3;
    wire                                      awvalid_s1_m3;
    wire [`AXI_AW_PYLD_S_W-1:0]               awpayload_s1_m3;
    wire                                      wready_s1_m3;
    wire                                      wvalid_s1_m3;
    wire [`AXI_W_PYLD_S_W-1:0]               wpayload_s1_m3;
    wire                                      bvalid_s1_m3;
    wire                                      bready_s1_m3;
    wire [`AXI_R_PYLD_M_W-1:0]               rpayload_s2_m3;
    wire [`AXI_B_PYLD_M_W-1:0]               bpayload_s2_m3;
    wire                                      arready_s2_m3;
    wire                                      arvalid_s2_m3;
    wire [`AXI_AR_PYLD_S_W-1:0]               arpayload_s2_m3;
    wire                                      rvalid_s2_m3;
    wire                                      rready_s2_m3;
    wire                                      awready_s2_m3;
    wire                                      awvalid_s2_m3;
    wire [`AXI_AW_PYLD_S_W-1:0]               awpayload_s2_m3;
    wire                                      wready_s2_m3;
    wire                                      wvalid_s2_m3;
    wire [`AXI_W_PYLD_S_W-1:0]               wpayload_s2_m3;
    wire                                      bvalid_s2_m3;
    wire                                      bready_s2_m3;
    ...
    wire                                  blank_arvalid_m3;
    wire                                  blank_arready_m3;
    wire                                  blank_arpayload_m3;
    wire                                  blank_arqos_m3;
    wire                                  blank_rvalid_m3;
    wire                                  blank_rpayload_m3;
    wire                                  blank_rready_m3;
    wire                                  blank_awvalid_m3;
    wire                                  blank_awready_m3;
    wire                                  blank_awpayload_m3;
    wire                                  blank_awqos_m3;
    wire                                  blank_wvalid_m3;
    wire                                  blank_wready_m3;
    wire                                  blank_wpayload_m3;
    wire                                  blank_bvalid_m3;
    wire                                  blank_bpayload_m3;
    wire                                  blank_bready_m3;
...
// --------------------------------------------------  
// Connect slave port wires to per master port wires.  
wire blank_aw_shrd_lyr_granted_m3_s_bus;
  assign {blank_aw_shrd_lyr_granted_m3_s_bus, aw_shrd_lyr_granted_m3_s_bus} = {1'b0
  , aw_shrd_lyr_granted_s2
  , aw_shrd_lyr_granted_s1
  , aw_shrd_lyr_granted_s0
};
...
wire blank_issued_wtx_shrd_sys_m2_s_bus;
  ...
  , (`AXI_S2_ON_AW_SHARED_VAL ? issued_wtx_shrd_sys_m2_s2 : 1'b0)
...
// issued_wtx_shrd_sys_mx_sy bits for that master from 
// all slaves.
wire blank_issued_wtx_shrd_sys_m3_s_bus;
  assign {blank_issued_wtx_shrd_sys_m3_s_bus, issued_wtx_shrd_sys_m3_s_bus} = {1'b0
  , (`AXI_S2_ON_AW_SHARED_VAL ? issued_wtx_shrd_sys_m3_s2 : 1'b0)
  , (`AXI_S1_ON_AW_SHARED_VAL ? issued_wtx_shrd_sys_m3_s1 : 1'b0)
  , (`AXI_S0_ON_AW_SHARED_VAL ? issued_wtx_shrd_sys_m3_s0 : 1'b0)
};
...
// --------------------------------------------------  
// Connect slave port wires to per master port wires.  
  assign {blank_rvalid_m3, bus_rvalid_m3} = {1'b0
      ,rvalid_s2_m3
      ,rvalid_s1_m3
      ,rvalid_s0_m3
};
...
// --------------------------------------------------  
// Connect slave port wires to per master port wires.  
  assign {blank_bvalid_m3, bus_bvalid_m3} = {1'b0
      ,bvalid_s2_m3
      ,bvalid_s1_m3
      ,bvalid_s0_m3
};
...
// Connect slave port wires to per master port wires.  
  assign {blank_arready_m2, bus_arready_m2} = {1'b0
      ,(`AXI_AR_LAYER_S2_M2 ? arready_shrd_sp_m2 : arready_s2_m2)
...
// --------------------------------------------------  
// Connect slave port wires to per master port wires.  
  assign {blank_arready_m3, bus_arready_m3} = {1'b0
      ,(`AXI_AR_LAYER_S2_M3 ? arready_shrd_sp_m3 : arready_s2_m3)
      ,(`AXI_AR_LAYER_S1_M3 ? arready_shrd_sp_m3 : arready_s1_m3)
      ,(`AXI_AR_LAYER_S0_M3 ? arready_shrd_sp_m3 : arready_s0_m3)
};
...
// Connect slave port wires to per master port wires.  
  assign {blank_awready_m2, bus_awready_m2} = {1'b0
      ,(`AXI_AW_LAYER_S2_M2 ? awready_shrd_sp_m2 : awready_s2_m2)
...
// --------------------------------------------------  
// Connect slave port wires to per master port wires.  
  assign {blank_awready_m3, bus_awready_m3} = {1'b0
      ,(`AXI_AW_LAYER_S2_M3 ? awready_shrd_sp_m3 : awready_s2_m3)
      ,(`AXI_AW_LAYER_S1_M3 ? awready_shrd_sp_m3 : awready_s1_m3)
      ,(`AXI_AW_LAYER_S0_M3 ? awready_shrd_sp_m3 : awready_s0_m3)
};
...
// Connect slave port wires to per master port wires.  
  assign {blank_wready_m2, bus_wready_m2} = {1'b0
      ,(`AXI_W_LAYER_S2_M2 ? wready_shrd_sp_m2 : wready_s2_m2)
...
// --------------------------------------------------  
// Connect slave port wires to per master port wires.  
  assign {blank_wready_m3, bus_wready_m3} = {1'b0
      ,(`AXI_W_LAYER_S2_M3 ? wready_shrd_sp_m3 : wready_s2_m3)
      ,(`AXI_W_LAYER_S1_M3 ? wready_shrd_sp_m3 : wready_s1_m3)
      ,(`AXI_W_LAYER_S0_M3 ? wready_shrd_sp_m3 : wready_s0_m3)
};
...
// If BIDI is enabled, pass icm with payload to all dedicated master  
// ports, they will strip off extra bits as required.
  wire dummy_bus_rpayload_m3;
 // Done to remove lint error STAR 9000441836
  assign {dummy_bus_rpayload_m3, bus_rpayload_m3} = { 1'b0
    , rpayload_s2_m3
    , rpayload_s1_m3
    , rpayload_s0_m3
 };
...
// If BIDI is enabled, pass icm with payload to all dedicated master  
// ports, they will strip off extra bits as required.
  wire dummy_bus_bpayload_m3;
 // Done to remove lint error STAR 9000441836
  assign {dummy_bus_bpayload_m3, bus_bpayload_m3} = { 1'b0
    , bpayload_s2_m3
    , bpayload_s1_m3
    , bpayload_s0_m3
 };
...
// SJ : This is not a functional issue, this is as per the requirement.
//      Hence this can be waived.
  assign { blank_arpayload_m3
  , arpayload_s2_m3
  , arpayload_s1_m3
  , arpayload_s0_m3
  } = {1'b0, {`AXI_NSP1V_M3{mp_arpayload_m3}}};
// spyglass enable_block W164a
...
// Connect master port wires to per slave port wires.  
  assign {blank_rready_s0, bus_rready_s0} = {
     1'b0
      , (`AXI_R_LAYER_M3_S0 ? rready_shrd_mp_s0 : rready_s0_m3)
...
// Connect master port wires to per slave port wires.  
  assign {blank_rready_s1, bus_rready_s1} = {
     1'b0
      , (`AXI_R_LAYER_M3_S1 ? rready_shrd_mp_s1 : rready_s1_m3)
...
// Connect master port wires to per slave port wires.  
  assign {blank_rready_s2, bus_rready_s2} = {
     1'b0
      , (`AXI_R_LAYER_M3_S2 ? rready_shrd_mp_s2 : rready_s2_m3)
      , (`AXI_R_LAYER_M2_S2 ? rready_shrd_mp_s2 : rready_s2_m2)
...
// SJ : This is not a functional issue, this is as per the requirement.
//      Hence this can be waived.
  assign { blank_rready_m3
    , rready_s2_m3
    , rready_s1_m3
    , rready_s0_m3
  } = {1'b0, {bus_mp_rready_m3}};
// spyglass enable_block W164a
...
// SJ : This is not a functional issue, this is as per the requirement.
//      Hence this can be waived.
  assign { blank_awpayload_m3
  , awpayload_s2_m3
  , awpayload_s1_m3
  , awpayload_s0_m3
  } = {1'b0, {`AXI_NSP1V_M3{mp_awpayload_m3}}};
// spyglass enable_block W164a
...
// SJ : This is not a functional issue, this is as per the requirement.
//      Hence this can be waived.
  assign { blank_wpayload_m3
  , wpayload_s2_m3
  , wpayload_s1_m3
  , wpayload_s0_m3
  } = {1'b0, {`AXI_NSP1V_M3{mp_wpayload_m3}}};
// spyglass enable_block W164a
...
// Connect master port wires to per slave port wires.  
  assign {blank_bready_s0, bus_bready_s0} = {
     1'b0
      , (`AXI_B_LAYER_M3_S0 ? bready_shrd_mp_s0 : bready_s0_m3)
...
// Connect master port wires to per slave port wires.  
  assign {blank_bready_s1, bus_bready_s1} = {
     1'b0
      , (`AXI_B_LAYER_M3_S1 ? bready_shrd_mp_s1 : bready_s1_m3)
...
// Connect master port wires to per slave port wires.  
  assign {blank_bready_s2, bus_bready_s2} = {
     1'b0
      , (`AXI_B_LAYER_M3_S2 ? bready_shrd_mp_s2 : bready_s2_m3)
      , (`AXI_B_LAYER_M2_S2 ? bready_shrd_mp_s2 : bready_s2_m2)
...
// SJ : This is not a functional issue, this is as per the requirement.
//      Hence this can be waived.
  assign { blank_bready_m3
    , bready_s2_m3
    , bready_s1_m3
    , bready_s0_m3
  } = {1'b0, {bus_mp_bready_m3}};
// spyglass enable_block W164a
 ...
 wire    [`AXI_QOSW-1:0]        awqos_m2_q;
  ...
  assign awpayload_m2 = {
   ...
   awcache_m2,
    awprot_m2 };
  assign wpayload_m2 = {
 {`AXI_IDW_M2{1'b0}}, //AXI 4 mode - WID is removed however assigned all bits 0 to kept the payload size intact. 
...
// spyglass enable_block W164b
 ...
 wire     [`AXI_QOSW-1:0]        arqos_m3_reg;
 wire     [`AXI_QOSW-1:0]        arqos_m3_r;
 wire     [`AXI_QOSW-1:0]        arqos_m3_q;
  ...
  assign arpayload_m3 = {
   ...
   arcache_m3,
    arprot_m3 };
 wire    [`AXI_QOSW-1:0]        awqos_m3_reg;
 wire    [`AXI_QOSW-1:0]        awqos_m3_r;
 wire    [`AXI_QOSW-1:0]        awqos_m3_q;
  ...
  assign awpayload_m3 = {
   ...
   awcache_m3,
    awprot_m3 };
  assign wpayload_m3 = {
 {`AXI_IDW_M3{1'b0}}, //AXI 4 mode - WID is removed however assigned all bits 0 to kept the payload size intact. 
    wdata_m3,    wstrb_m3,    wlast_m3 };
// spyglass disable_block W164b
// SMD: Identifies assignments in which the LHS width is greater than the RHS width
// SJ : This is not a functional issue, this is as per the requirement.
// spyglass disable_block W164a
...
// SJ : This is not a functional issue, this is as per the requirement.
  assign {
    rid_m3,    rdata_m3,    rresp_m3,    rlast_m3 }  = `AXI_M3_ON_R_SHARED_ONLY_VAL ? (`AXI_IS_ICM_M3 ? rpayload_icm_shrd : rpayload_shrd) : rpayload_m3;
// spyglass enable_block W164a
// spyglass enable_block W164b
// spyglass disable_block W164b
// SMD: Identifies assignments in which the LHS width is greater than the RHS width
...
// SJ : This is not a functional issue, this is as per the requirement.
  assign {
    bid_m3,    bresp_m3 }  = `AXI_M3_ON_B_SHARED_ONLY_VAL ? (`AXI_IS_ICM_M3 ? bpayload_icm_shrd : bpayload_shrd) : bpayload_m3;
// spyglass enable_block W164a
// spyglass enable_block W164b
...
// spyglass enable_block W164a
  ...
  assign bpayload_s2 = {
   ...
   assign priority_m2 = `AXI_PRIORITY_M2;
    wire [`AXI_MST_PRIORITY_W-1:0] priority_m3;
   assign priority_m3 = `AXI_PRIORITY_M3;
  ...
  wire [(`AXI_SLV_PRIORITY_W*`AXI_R_M3_NSV)-1:0] r_bus_slv_priorities_m3;
  wire r_blank_priority_m3;
  assign {r_blank_priority_m3,r_bus_slv_priorities_m3} = {1'b0
        , priority_s2
        , priority_s1
        , priority_s0
 };
  ...
  wire [(`AXI_SLV_PRIORITY_W*`AXI_B_M3_NSV)-1:0] b_bus_slv_priorities_m3;
  wire b_blank_priority_m3;
  assign {b_blank_priority_m3,b_bus_slv_priorities_m3} = {1'b0
        , priority_s2
        , priority_s1
        , priority_s0
 };
...
assign rcpl_id_shrd = {{`AXI_MIDW{1'b0}}};
  ...
  // Select between shared and dedicated channel valid signals for
  // each master.
       assign rvalid_m3 = `AXI_M3_ON_R_SHARED_ONLY_VAL
                                 ? rvalid_shrd_m3 
                                 : rvalid_ddctd_m3;
...
assign wcpl_id_shrd = {{`AXI_MIDW{1'b0}}};
  ...
  // Select between shared and dedicated channel valid signals for
  // each master.
       assign bvalid_m3 = `AXI_M3_ON_B_SHARED_ONLY_VAL
                                 ? bvalid_shrd_m3 
                                 : bvalid_ddctd_m3;
...
assign mp_awvalid_m2 = mp_awvalid_m2_q;
  ...
  DW_axi_mp
   #(`AXI_SYS_NUM_FOR_M3 - 1, `AXI_IS_ICM_M3, `AXI_NSP1V_M3, `AXI_LOG2_NSP1V_M3, `AXI_R_M3_NSV, `AXI_R_M3_NSV_LOG2, `AXI_R_M3_NSV_P1_LOG2, `AXI_B_M3_NSV, `AXI_B_M3_NSV_LOG2, `AXI_B_M3_NSV_P1_LOG2, `AXI_R_ARB_TYPE_M3, `AXI_B_ARB_TYPE_M3, `AXI_R_MCA_EN_M3, `AXI_B_MCA_EN_M3, `AXI_R_MCA_NC_M3, `AXI_B_MCA_NC_M3, `AXI_R_MCA_NC_W_M3, `AXI_B_MCA_NC_W_M3, 1,  /* Default slave always visible in normal mode. */ `AXI_NV_S1_BY_M3, `AXI_NV_S2_BY_M3, `AXI_NV_S3_BY_M3, `AXI_NV_S4_BY_M3, `AXI_NV_S5_BY_M3, `AXI_NV_S6_BY_M3, `AXI_NV_S7_BY_M3, `AXI_NV_S8_BY_M3, `AXI_NV_S9_BY_M3, `AXI_NV_S10_BY_M3, `AXI_NV_S11_BY_M3, `AXI_NV_S12_BY_M3, `AXI_NV_S13_BY_M3, `AXI_NV_S14_BY_M3, `AXI_NV_S15_BY_M3, `AXI_NV_S16_BY_M3, 1,  /* Default slave always visible in boot mode. */ `AXI_BV_S1_BY_M3, `AXI_BV_S2_BY_M3, `AXI_BV_S3_BY_M3, `AXI_BV_S4_BY_M3, `AXI_BV_S5_BY_M3, `AXI_BV_S6_BY_M3, `AXI_BV_S7_BY_M3, `AXI_BV_S8_BY_M3, `AXI_BV_S9_BY_M3, `AXI_BV_S10_BY_M3, `AXI_BV_S11_BY_M3, `AXI_BV_S12_BY_M3, `AXI_BV_S13_BY_M3, `AXI_BV_S14_BY_M3, `AXI_BV_S15_BY_M3, `AXI_BV_S16_BY_M3, `AXI_MAX_RCA_ID_M3, `AXI_MAX_WCA_ID_M3, `AXI_MAX_URIDA_M3, `AXI_MAX_UWIDA_M3, `AXI_LOG2_MAX_RCA_ID_P1_M3, `AXI_LOG2_MAX_WCA_ID_P1_M3, `AXI_LOG2_MAX_URIDA_M3, `AXI_LOG2_MAX_UWIDA_M3, `AXI_RI_LIMIT_M3
,`AXI_AR_LAYER_S0_M3 ,`AXI_AR_LAYER_S1_M3 ,`AXI_AR_LAYER_S2_M3 ,`AXI_AR_LAYER_S3_M3 ,`AXI_AR_LAYER_S4_M3 ,`AXI_AR_LAYER_S5_M3 ,`AXI_AR_LAYER_S6_M3 ,`AXI_AR_LAYER_S7_M3 ,`AXI_AR_LAYER_S8_M3 ,`AXI_AR_LAYER_S9_M3 ,`AXI_AR_LAYER_S10_M3 ,`AXI_AR_LAYER_S11_M3 ,`AXI_AR_LAYER_S12_M3 ,`AXI_AR_LAYER_S13_M3 ,`AXI_AR_LAYER_S14_M3 ,`AXI_AR_LAYER_S15_M3 ,`AXI_AR_LAYER_S16_M3 ,`AXI_AW_LAYER_S0_M3 ,`AXI_AW_LAYER_S1_M3 ,`AXI_AW_LAYER_S2_M3 ,`AXI_AW_LAYER_S3_M3 ,`AXI_AW_LAYER_S4_M3 ,`AXI_AW_LAYER_S5_M3 ,`AXI_AW_LAYER_S6_M3 ,`AXI_AW_LAYER_S7_M3 ,`AXI_AW_LAYER_S8_M3 ,`AXI_AW_LAYER_S9_M3 ,`AXI_AW_LAYER_S10_M3 ,`AXI_AW_LAYER_S11_M3 ,`AXI_AW_LAYER_S12_M3 ,`AXI_AW_LAYER_S13_M3 ,`AXI_AW_LAYER_S14_M3 ,`AXI_AW_LAYER_S15_M3 ,`AXI_AW_LAYER_S16_M3 ,`AXI_W_LAYER_S0_M3 ,`AXI_W_LAYER_S1_M3 ,`AXI_W_LAYER_S2_M3 ,`AXI_W_LAYER_S3_M3 ,`AXI_W_LAYER_S4_M3 ,`AXI_W_LAYER_S5_M3 ,`AXI_W_LAYER_S6_M3 ,`AXI_W_LAYER_S7_M3 ,`AXI_W_LAYER_S8_M3 ,`AXI_W_LAYER_S9_M3 ,`AXI_W_LAYER_S10_M3 ,`AXI_W_LAYER_S11_M3 ,`AXI_W_LAYER_S12_M3 ,`AXI_W_LAYER_S13_M3 ,`AXI_W_LAYER_S14_M3 ,`AXI_W_LAYER_S15_M3 ,`AXI_W_LAYER_S16_M3 ,`AXI_AW_S0_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S1_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S2_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S3_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S4_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S5_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S6_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S7_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S8_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S9_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S10_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S11_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S12_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S13_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S14_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S15_HAS_SHRD_DDCTD_LNK_VAL ,`AXI_AW_S16_HAS_SHRD_DDCTD_LNK_VAL , `AXI_M3_ON_R_SHARED_ONLY_VAL, `AXI_M3_ON_B_SHARED_ONLY_VAL, `ACT_ID_BUF_POINTER_W_AW_M3, `LOG2_ACT_ID_BUF_POINTER_W_AW_M3, `ACT_ID_BUF_POINTER_W_AR_M3, `LOG2_ACT_ID_BUF_POINTER_W_AR_M3
  )
  U_DW_axi_mp_m3 (
    .aclk_i                      (aclk),
    .aresetn_i                   (aresetn),
    .r_bus_slv_priorities_i      (r_bus_slv_priorities_m3),
    .b_bus_slv_priorities_i      (b_bus_slv_priorities_m3),

// Read Address Channel
    .arvalid_i                   (arvalid_m3),
    .arpayload_i                 (arpayload_m3),
    .arready_o                   (arready_m3),
    .bus_arready_i               (bus_arready_m3),
    .bus_arvalid_o               (mp_arvalid_m3_q),
    .ar_shrd_ch_req_o            (ar_shrd_ch_req_m3),
    .arpayload_o                 (mp_arpayload_m3),
// Read Data Channel
    .rready_i                    (rready_m3),
    .rvalid_o                    (rvalid_ddctd_m3),
    .rpayload_o                  (rpayload_m3),
    .bus_rvalid_i                (bus_rvalid_m3),
    .bus_rpayload_i              (bus_rpayload_m3),
    .bus_rready_o                (bus_mp_rready_m3),
    .rcpl_tx_shrd_i              (rcpl_tx_shrd_sys_m3),
    .rcpl_id_shrd_i              (rcpl_id_shrd[`AXI_MIDW-1:0]),
// Write Address Channel
    .awvalid_i                   (awvalid_m3),
    .awpayload_i                 (awpayload_m3),
    .awready_o                   (awready_m3),
    .bus_awready_i               (bus_awready_m3),
    .aw_shrd_lyr_granted_s_bus_i (aw_shrd_lyr_granted_m3_s_bus),
    .issued_wtx_shrd_sys_s_bus_i (issued_wtx_shrd_sys_m3_s_bus),
    .bus_awvalid_o               (mp_awvalid_m3_q),
    .aw_shrd_ch_req_o            (aw_shrd_ch_req_m3),
    .awpayload_o                 (mp_awpayload_m3),
// Write Data Channel
    .wvalid_i                    (wvalid_m3),
    .wpayload_i                  (wpayload_m3),
    .wready_o                    (wready_m3),
    .bus_wready_i                (bus_wready_m3),
    .bus_wvalid_o                (mp_wvalid_m3),
    .w_shrd_ch_req_o             (w_shrd_ch_req_m3),
    .wpayload_o                  (mp_wpayload_m3),
//Burst Response Channel
    .bready_i                    (bready_m3),
    .bvalid_o                    (bvalid_ddctd_m3),
    .bpayload_o                  (bpayload_m3),
    .bus_bvalid_i                (bus_bvalid_m3),
    .bus_bpayload_i              (bus_bpayload_m3),
    .bus_bready_o                (bus_mp_bready_m3),
    .wcpl_tx_shrd_i              (wcpl_tx_shrd_sys_m3),
    .wcpl_id_shrd_i              (wcpl_id_shrd[`AXI_MIDW-1:0])
  );
 
assign mp_arvalid_m3 = mp_arvalid_m3_q;
  
 
assign mp_awvalid_m3 = mp_awvalid_m3_q;

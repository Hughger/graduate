...
output  [`APB_DATA_WIDTH-1:0]   prdata;
 ...
 wire    [`IC_ADDR_SLICE_LHS-2:0]  reg_addr;  // Register address offset
...
wire  [`APB_DATA_WIDTH-1:0]   prdata;
     ...
     wire  [`AXI_QOSW-1: 0]       reg_awqos_m1;
     wire  [`AXI_QOSW-1: 0]       reg_arqos_m1;
  
    wire  [`AXI_QOSW-1: 0]        reg_awqos_m2;
    wire  [`AXI_QOSW-1: 0]        reg_arqos_m2;
     wire  [`AXI_QOSW-1: 0]       reg_awqos_m3;
     wire  [`AXI_QOSW-1: 0]       reg_arqos_m3;
...
#(.WIDTH(1),.F_SYNC_TYPE(`AXI_NUM_SYNC_FF),.VERIF_EN(`AXI_VERIF_EN))U_DW_axi_bcm21_command_en_aclk
      (
         .clk_d               (aclk)
        ,.rst_d_n             (aresetn)
        ,.data_s              (command_en)
...
#(.WIDTH(1),.F_SYNC_TYPE(`AXI_NUM_SYNC_FF),.VERIF_EN(`AXI_VERIF_EN))U_DW_axi_bcm21_command_en_pclk
      (
         .clk_d               (pclk)
        ,.rst_d_n             (presetn)
...
DW_axi_bcm21 
 #(.WIDTH(1),.F_SYNC_TYPE(`AXI_NUM_SYNC_FF),.VERIF_EN(`AXI_VERIF_EN))U_DW_axi_bcm21_err_bit_pclk
      (
         .clk_d               (pclk)
        ,.rst_d_n             (presetn)
        ,.data_s              (err_bit)
 ...
 DW_axi_qos_regfile
  U_DW_axi_qos_regfile
    ...
    .reg_awqos_m3   (reg_awqos_m3),
    .reg_arqos_m3   (reg_arqos_m3),

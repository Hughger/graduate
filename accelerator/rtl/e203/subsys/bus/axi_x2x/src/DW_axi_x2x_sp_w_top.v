...
//----------------------------------------------------------------------
  ...
  input [`X2X_BSW-1:0]        asize_mp_i; 
  input [`X2X_SP_BLW-1:0]     alen_i;
  input [`X2X_BTW-1:0]        aburst_i; 
  input [`X2X_BSW-1:0]        asize_sp_i; 
  input [`X2X_ADDR_TRK_W-1:0] addr_i; 

...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2x/amba_dev/src/DW_axi_x2x_sp_b_rsfifos.v#10 $ 
**
** ---------------------------------------------------------------------
**
...
module DW_axi_x2x_sp_b_rsfifos (
  // Inputs - Push Side 
  clk_i,
  resetn_i,

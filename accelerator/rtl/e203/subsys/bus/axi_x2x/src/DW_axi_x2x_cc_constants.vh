...
//==============================================================================
`define __GUARD__DW_AXI_X2X_CC_CONSTANTS__VH__
...
`define X2X_LOG2_MAX_MP_BYTES 2


//Log base 2 of maximum possible number of bytes in X2X_MP_DW.

`define X2X_0LOG2_MAX_MP_BYTES 2
...
`define X2X_AW_BUF_DEPTH_L2 3


//Log base 2 of (X2X_AW_BUF_DEPTH+1)

`define X2X_AW_BUF_DEPTH_P1L2 4
...
`define X2X_B_BUF_DEPTH_L2 3


//Log base 2 of (X2X_B_BUF_DEPTH+1)

`define X2X_B_BUF_DEPTH_P1L2 4


//Log base 2 of X2X_AR_BUF_DEPTH

`define X2X_AR_BUF_DEPTH_L2 3


//Log base 2 of (X2X_AR_BUF_DEPTH+1)

`define X2X_AR_BUF_DEPTH_P1L2 4
...
`define X2X_MP_BLW_LRGR_OR_SAME


`define X2X_AXI_MP_NUM_MASTERS 1


`define X2X_AXI_MP_NUM_SLAVES 0


`define X2X_AXI_SP_NUM_MASTERS 0


`define X2X_AXI_SP_NUM_SLAVES 1

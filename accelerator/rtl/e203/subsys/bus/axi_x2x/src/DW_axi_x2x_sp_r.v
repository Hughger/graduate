...
module DW_axi_x2x_sp_r (
  ...
  parameter RS_FK_BP   = NO_ALTER && `X2X_HAS_ET;  //1 -> bypass RS but not bypass RS fifos.
                                                   //We need mp_asize and aid for endian transform.
  // spyglass enable_block W576
  parameter RS_BYPASS  = NO_ALTER && ((`X2X_HAS_ET==0)); //1 -> bypass resizer

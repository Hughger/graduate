...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2x/amba_dev/src/DW_axi_x2x_busmux_ohsel.v#8 $ 
--
...
module DW_axi_x2x_busmux_ohsel ( sel, din, dout );
  ...
  // SJ : dout is initialized before entering into nested for loops to avoid latches.

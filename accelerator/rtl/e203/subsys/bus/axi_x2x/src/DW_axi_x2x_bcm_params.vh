...
//
// Filename    : DW_axi_x2x_bcm_params.v
// Revision    : $Id: //dwh/DW_ocb/DW_axi_x2x/amba_dev/src/DW_axi_x2x_bcm_params.vh#1 $
// Author      : Build Meister - 12/09/08
// Description : DW_axi_x2x_bcm_params.v Verilog module for DW_axi_x2x
//
...
// Start Guard
//==============================================================================
`define __GUARD__DW_AXI_X2X_BCM_PARAMS__VH__

...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2x/amba_dev/src/DW_axi_x2x_sp.v#10 $ 
**
** --------------------------------------------------------------------
**
...
//  input [`X2X_NUM_W_PORTS-1:0] b_push_full_i;
  ...
  wire [SP_BL_W-1:0]    ar_alen_unconn; 
  wire                  us_xact_issue_off_unconn; 
  ...
  //--------------------------------------------------------------------
  // Depending on read/write channel some signals may be tied to zeros.
  // - Signals last_rs_xact_o, pre_last_xact_o, us_xact_issue_off_o based on multiple parameters are tied to zeros.
  //spyglass disable_block W528
  //SMD: A signal or variable is set but never read.
  //SJ : unused signal from x2x_sp_a module that is instantiated twice. Dummy wires - used to suppress unconnected ports warnings. 
  DW_axi_x2x_sp_a
  ...
  // Read Data Channel.
  //--------------------------------------------------------------------
  // Depending on RS_BYPASS paramter channel the rs_push_full_o signal may be tied to zeros.
  DW_axi_x2x_sp_r
  ...
  //--------------------------------------------------------------------
  //  Depending on read/write channel some signals may be tied to zeros.
  // - Signal us_xact_issue_off_o (if X2X_WIP_BYPASS is defined) is tied to zeros.
  //spyglass disable_block W528
  //SMD: A signal or variable is set but never read.
  //SJ : unused signal from x2x_sp_a module that is instantiated twice. Dummy wires - used to suppress unconnected ports warnings.
  DW_axi_x2x_sp_a

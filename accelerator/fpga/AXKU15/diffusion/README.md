...
The bring-up flow was run with Vivado 2024.2 on this repository revision. It completed synthesis, implementation and bitstream generation for `xcku15p-ffve1517-2-i` with zero DRC errors. At a 200 MHz constraint, the post-route setup WNS was **4.220 ns** (TNS 0.000 ns); the generated bitstream was 36,343,241 bytes. These numbers apply only to the small clock/LED smoke top, not to the future DDR4/MIG accelerator implementation.

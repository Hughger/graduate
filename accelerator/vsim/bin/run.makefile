...
TESTCASE     := ${RUN_DIR}/../../c/axi_test/axi_test
DUMPWAVE     := 1
...
RTL_V_FILES		:= $(wildcard  ${VSRC_DIR}/*/*.v ${VSRC_DIR}/*/*/*.v ${VSRC_DIR}/*/*/*/*.v ${VSRC_DIR}/*/*/*/*/*.v ${VSRC_DIR}/*/*/*/*/*/*.v)
...
SIM_OPTIONS   += +incdir+"${VSRC_DIR}/core/"+"${VSRC_DIR}/perips/"+"${VSRC_DIR}/perips/apb_i2c/"+"${VSRC_DIR}/subsys/bus/axi_matrix/src"+"${VSRC_DIR}/subsys/bus/axi_x2x/src"
endif
...
compile.flg: ${RTL_V_FILES} ${TB_V_FILES}
	...
	${SIM_TOOL} ${SIM_OPTIONS}  ${RTL_V_FILES} ${TB_V_FILES} 2>&1 | tee compile.log ;
	touch compile.flg
